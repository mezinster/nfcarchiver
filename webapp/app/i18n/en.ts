...
export const en = {
  ...
  aboutSupportedBody: 'Mifare Classic 1K and NTAG213/215/216 via a Chameleon Ultra over Web Bluetooth. NTAG only via the phone’s own NFC radio, on Chrome for Android.',
  aboutWebNfcNote: '(Phone NFC reads and writes NDEF only — Mifare Classic and card inspection need a Chameleon.)',
