...
export const be: Messages = {
  ...
  aboutSupportedBody: 'Mifare Classic 1K і NTAG213/215/216 праз Chameleon Ultra па Web Bluetooth. Толькі NTAG — праз уласны NFC тэлефона ў Chrome для Android.',
  aboutWebNfcNote: '(NFC тэлефона чытае і піша толькі NDEF — для Mifare Classic і агляду карты патрэбны Chameleon.)',
