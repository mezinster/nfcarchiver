...
export const pl: Messages = {
  ...
  aboutSupportedBody: 'Mifare Classic 1K i NTAG213/215/216 przez Chameleon Ultra po Web Bluetooth. Tylko NTAG — przez własne NFC telefonu w Chrome na Androida.',
  aboutWebNfcNote: '(NFC telefonu czyta i zapisuje tylko NDEF — Mifare Classic i zbadanie karty wymagają Chameleona.)',
