...
export const ka: Messages = {
  ...
  aboutSupportedBody: 'Mifare Classic 1K და NTAG213/215/216 Chameleon Ultra-ით Web Bluetooth-ზე. მხოლოდ NTAG — ტელეფონის საკუთარი NFC-ით, Chrome-ში Android-ისთვის.',
  aboutWebNfcNote: '(ტელეფონის NFC კითხულობს და წერს მხოლოდ NDEF-ს — Mifare Classic-სა და ბარათის დათვალიერებას სჭირდება Chameleon.)',
